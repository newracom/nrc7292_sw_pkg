...
def copyConf():
    if int(sys.argv[1]) == 4:
        os.system("sudo ~/nrc_pkg/sw/firmware/copy " + str(model) + " _ucode")
        os.system("~/nrc_pkg/script/conf/etc/ip_config.sh " + "STA " +  str(relay_type))
    else:
        os.system("sudo ~/nrc_pkg/sw/firmware/copy " + str(model))
        os.system("~/nrc_pkg/script/conf/etc/ip_config.sh " + strSTA() + " " +  str(relay_type))
...
def run_common():
    if int(max_cpuclock) == 1:
        ...
        os.system("sudo ~/nrc_pkg/script/conf/etc/clock_config.sh")
...
def run_ap(interface):
    ...
    if strSecurity() == 'OPEN':
        os.system("sed -i " + '"4s/.*/interface=' + interface + '/g"  ~/nrc_pkg/script/conf/' + country + '/ap_halow_open.conf ')
        os.system("sudo hostapd ~/nrc_pkg/script/conf/" + country + "/ap_halow_open.conf " + debug +" &")
    elif strSecurity() == 'WPA2-PSK':
        os.system("sed -i " + '"4s/.*/interface=' + interface + '/g"  ~/nrc_pkg/script/conf/' + country + '/ap_halow_wpa2.conf ')
        os.system("sudo hostapd ~/nrc_pkg/script/conf/" + country + "/ap_halow_wpa2.conf " + debug + "  &")
    elif strSecurity() == 'WPA3-OWE':
        os.system("sed -i " + '"4s/.*/interface=' + interface + '/g"  ~/nrc_pkg/script/conf/' + country + '/ap_halow_owe.conf ')
        os.system("sudo hostapd ~/nrc_pkg/script/conf/" + country + "/ap_halow_owe.conf " + debug + "  &")
    elif strSecurity() == 'WPA3-SAE':
        os.system("sed -i " + '"4s/.*/interface=' + interface + '/g"  ~/nrc_pkg/script/conf/' + country + '/ap_halow_sae.conf ')
...
if __name__ == '__main__':
    ...
    if strSTA() == 'STA' or strSTA() == 'STA+Ucode' :
        run_sta('wlan0')
    elif strSTA() == 'AP':
        run_ap('wlan0')
    elif strSTA() == 'SNIFFER':
